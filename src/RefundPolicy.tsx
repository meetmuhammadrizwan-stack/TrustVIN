      ...
      <div className="max-w-4xl mx-auto bg-white p-10 md:p-16 rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-100">
        ...
        <div className="prose prose-slate prose-lg max-w-none text-slate-600 space-y-8">
          <section>
            ...
            <p>
              <strong>1.2</strong> This policy should be read in conjunction
          ...
          <section>
            ...
            <p>
              <strong>3.1</strong> Delivery of the service is deemed complete
              when:
            </p>
            <ul className="list-[lower-alpha] pl-6 space-y-2 mt-4">
              ...
              <li>
                access to the report is provided to the customer via electronic
                means, including a secure dashboard, secure access link, or
                email notification.
              </li>
            </ul>
            <p className="mt-4">
              <strong>3.2</strong> Delivery is considered complete regardless of
              whether the customer opens, views, or downloads the report after
              access is provided.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>4.1</strong> Because the service is digital and delivered
              electronically, all sales are final and non-refundable once
              delivery is complete, except where required by applicable law.
            </p>
            <p>
              <strong>4.2</strong> Refunds may be considered only under the
            ...
            <ul className="list-[lower-alpha] pl-6 space-y-2 mt-4">
              ...
              <li>
                the delivered report does not correspond to the selected service
                tier.
              </li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              <strong>5.1</strong> Refunds will not be issued for:
            </p>
            <ul className="list-[lower-alpha] pl-6 space-y-2 mt-4">
              <li>
                dissatisfaction with report contents when the report was
                successfully delivered;
              </li>
              <li>
                claims that the report was not opened or downloaded after access
                was provided;
              </li>
              <li>changes of mind after purchase;</li>
              <li>
                limitations in data availability from third-party sources
          ...
          <section>
            ...
            <p>
              <strong>6.1</strong> Refund requests must be submitted within{" "}
              <strong>3 days</strong> of purchase.
            </p>
            <p>
              <strong>6.2</strong> The customer must provide:
            </p>
            <ul className="list-[lower-alpha] pl-6 space-y-2 mt-4">
              <li>order number;</li>
              <li>VIN;</li>
            ...
            <p className="mt-4">
              <strong>6.3</strong> Failure to provide the required information
              may result in denial of the refund request.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>7.1</strong> Approved refunds will be issued to the
              original payment method only.
            </p>
            <p>
              <strong>7.2</strong> Processing times may vary by financial
              institution but generally occur within{" "}
              <strong>3–7 business days</strong>.
            </p>
            <p>
              <strong>7.3</strong> Any non-refundable processing fees, where
              applicable, will not be returned.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>8.2</strong> Repeated refund requests may result in
              account restrictions or refusal of future service.
            </p>
          </section>
